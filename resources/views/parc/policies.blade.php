...
@section('content')
    ...
    <div class="flex justify-center mt-3">
        <div class="md:w-9/12 w-10/12 bg-white p-6 rounded-lg">
            <p>
                ...
                <h4 class="text-center" style="font-weight: bold;">Politique de location de voitures</h4>
                ...
                <h4 class="text-center mt-4" style="font-weight: bold;">Politique de prêt de voitures</h4>
                ...
                <h4 class="text-center mt-4" style="font-weight: bold;">Confidentialités CaRRentAL</h4>
