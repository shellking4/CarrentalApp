...
@section('content')
    <div class="flex justify-center mt-5">
        <div class="w-8/12 theme-ground p-6 rounded-lg">
            <h5 class="flex form-title text-white  text-center justify-center uppercase">LOCATIONS DE VOITURES DE L'UTILISATEUR  {{ $user->firstname }}  {{ $user->lastname }}</h5>
        </div>
    </div>
    <div class="container">
        @if (count($rents))
                    ...
                    <div class="col-11 col-md-10 offset-md-1">
                        <div class="row ml-4 item bg-dark text-white p-4 rounded-lg">
                            ...
                            <div class="col-12 col-md-6 mt-md-0 mt-4">
                                ...
                                <h5><span class="libele">Nombre de jours</span> : {{ $car->locationDaysNumber }} Jours</h5>
                                <h5><span class="libele">Montant de cette location</span> : {{ $car->costIfRented }} FCFA</h5>
                            </div>
                            <div class="col-md-12">
        ...
        @else
            <div class="container-fluid mt-4">
                <p class="text-center mt-4 uppercase">L'UTILISATEUR  {{ $user->firstname }}  {{ $user->lastname }} N'A PAS DE LOCATIONS DE VOITURES ENREGISTRÉES</p>
            </div>
        @endif
    </div>
    <div class="py-12"></div>
