    ...
    <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <form action="{{ route('user_free_rents', $user) }}" method="get">
                                                @csrf
                                                <button title="Les emprunts de voitures de l'utilisateur" type="submit"><span class="text-success mt-md-2 mt-4 fas fa-car"></span></button>
                                            </form>
                                        </div>
                                    </div>
                                </td>
        ...
        @else
            <div class="container-fluid mt-4 on_empty_message">
                <p class="text-center mt-4">PAS D'UTILISATEURS AYANT EMPRUNTÉ DE VOITURES</p>
            </div>
        @endif
    </div>
    <div class="py-12"></div>
